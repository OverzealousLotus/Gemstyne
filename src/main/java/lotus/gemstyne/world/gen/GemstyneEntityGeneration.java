...
public class GemstyneEntityGeneration {
    ...
    public static void addSpawns() {
        ...
        SpawnRestriction.register(EntityHandler.AETHER_ZOMBIE, SpawnLocationTypes.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
            HostileEntity::canSpawnInDark); // A Zombie is a hostile entity, so we use this class.
    }
}
